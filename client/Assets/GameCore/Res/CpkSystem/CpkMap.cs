...
//                }
//                LogMgr.Log("不包含注册File" + mainDictionary[fileName].Value);
//            }
//            LogMgr.Log("查表失败");
//            blockNodeIndex = -1;
//            return null;
...
//        {
//            byte[] bytes = null;// ResourceProxyManager.Instance.LoadFileInStreamingAssets(AxpMap.MAPNAME);
//            if (bytes == null)
//            {
//                return false;
//            }
...
//            if (num < 1 || num > 100000)
//                return false;
//            LogMgr.Log("AxpMap GameVersion : {0}, ResFirstVersion : {1}, ResSecondVersion : {2}, ResThirdVersion : {3}", t_GameVersion, t_ResFirstVersion, t_ResSecondVersion, t_ResThirdVersion);

...
public class GameFrameWork_AssetManagerWrap
{
	...
	static int Init(IntPtr L)
	{
		try
		{
			...
			GameFrameWork.AssetManager.Init();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int LateLoop(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			GameFrameWork.AssetManager.LateLoop();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int Exit(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			GameFrameWork.AssetManager.Exit();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int LoadAsset(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				LuaInterface.LuaByteBuffer o = GameFrameWork.AssetManager.LoadAsset(arg0);
				ToLua.Push(L, o);
				return 1;
			}
			else if (count == 4 && TypeChecker.CheckTypes<System.Action<int,LuaInterface.LuaByteBuffer>, bool>(L, 3))
			{
				...
				GameFrameWork.AssetManager.LoadAsset(arg0, arg1, arg2, arg3);
				return 0;
			}
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: GameFrameWork.AssetManager.LoadAsset");
			}
		}
		catch (Exception e)
		{
	...
	static int DestroyAsset(IntPtr L)
	{
		try
		{
			...
			GameFrameWork.AssetManager.DestroyAsset(arg0);
			return 0;
		}
		catch (Exception e)
		{
